...
class Movies extends Component {
  ...
  render() {
    ...
    const { currentPage, pageSize, sortColumn, genres, selectedGenre } = this.state;
    ...
    return (
      <div className="row">
        ...
        <div className="col">
          ...
          <MoviesTable movies={movies} sortColumn={sortColumn} onDelete={this.handleDelete} onSort={this.handleSort} onLike={this.handleLike} />
